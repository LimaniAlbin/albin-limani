...
export const BentoGridItem = ({
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('albinn012@gmail.com')
                    ...
                    {id === 3 && (
                        <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
                            <div className="flex flex-col gap-3 lg:gap-8">
                                {['React.js', 'Vue.js', 'TypeScript'].map(
                                    (item) => (
                                        <span key={item}
                            ...
                            <div className="flex flex-col gap-3 lg:gap-8 pr-1">
                                <span className="py-4 px-3 rounded-lg text-center bg-[#10132E]"/>
                                {['Next.js', 'Nuxt', 'Node.js'].map(
                                    (item) => (
                                        <span key={item}
                                              className="py-2 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]"
                                        >
